                ...
                <nav class="nav-main">
                    <ul id="topMain" class="nav nav-pills nav-main" style="text-align:center;">
                        ...
                        <li class="mega-menu" frag="窗口10204">
                            <a class="js-scroll-trigger" href="index.php?r=site/visual">疫情可视化</a>
                        </li>
...
<section class="index-news commit_title" id="comment" style="padding-bottom: 20px; padding-top: 30px;">
    <center>
        <h1 style="padding-bottom:20px;font-family:华文中宋;border-bottom:1px solid #ddd;text-align: center;">同心协力，共克时艰
        </h1>
    </center>
    <div class="container">
        ...
        <div class="body-content">
            ...
            <div class="col-lg-3">
                <span class="input-group-btn">
                    <button type="button" data-url="<?=Url::to(['site/add-wish'])?>" class='btn btn-success btn-wish j-wish'>留言</button>
                </span>
            </div>
        </div>
        </div>
